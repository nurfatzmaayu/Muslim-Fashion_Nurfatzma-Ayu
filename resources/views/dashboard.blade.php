            ...
            <div class="card card-compact bg-base-100 shadow-xl">
                ...
                <div class="card-body">
                    ...
                    <div class="card-actions justify-end">
                        ...
                        @auth
                        <a href="{{ route('pesan', $barang->id) }}" class="btn bg-teal-600 border-0 btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-plus-fill" viewBox="0 0 16 16">
