<x-app-layout>
    <x-container>
        <div class="flex items-center">
            ...
            <div class="w-1/2 text-center">
                <span class="block text-xl uppercase"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-chat-left-quote-fill text-teal-600 " viewBox="0 0 16 16">
    ...
    <x-container>
        <div class="flex items-center py-12">
            <div class="w-3/4">
                <div class="flex items-center gap-12 justify-start">
                    <a href="" class="block">All</a>
                    <a href="" class="block">T-Shirt</a>
                    <a href="" class="block">Pants</a>
                    <a href="" class="block">Bag</a>
                    <a href="" class="block">Shoes</a>
                    <a href="" class="block">Skincare</a>
                </div>
            </div>
            <div class="w-1/4">
